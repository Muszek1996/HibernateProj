...
import DataManipulators.PlayerManipulator;
...
public class RestController {
    private PlayerManipulator playerManipulator;
    private PlayerRepository playerRepository;

    @Autowired
    RestController(PlayerManipulator playerManipulator,PlayerRepository playerRepository){
    ...
    public PlayerEntity getPlayer(@RequestParam(value = "steamid") long steamId) {
